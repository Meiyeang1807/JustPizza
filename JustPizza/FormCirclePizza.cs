...
namespace JustPizza
{
    public partial class FormCirclePizza : Form
    {
        ...
        public FormCirclePizza()
        {
            ...
            string connectionString = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\C# CODING\\JustPizza\\JustPizza\\JustPizzaDatabase.mdf;Integrated Security=True";
